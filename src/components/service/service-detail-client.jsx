...
function StoreMockup({ category }) {
  ...
  const key = category.toLowerCase().includes("shopify")
    ? "shopify"
    ...
    <div className="relative max-w-md mx-auto">
      ...
      <div className="relative bg-gray-900 rounded-2xl p-3 shadow-2xl border border-gray-700">
        ...
        <div className="bg-white rounded-xl overflow-hidden">
          {/* Nav */}
          <div
            className={`${header === "bg-sky-400" ? "bg-sky-600" : "bg-gray-900"} h-9 flex items-center px-4 gap-6`}
          >
            <div className="w-16 h-3 bg-white/80 rounded-full" />
            <div className="flex gap-3 ml-auto">
              {[1, 2, 3].map((i) => (
                <div key={i} className="w-8 h-2.5 bg-white/30 rounded-full" />
              ))}
            </div>
          </div>
          {/* Hero */}
...
function FAQItem({ question, answer }) {
  ...
  return (
    <div
      className={`border rounded-2xl overflow-hidden transition-all duration-300 ${open ? "border-sky-200 shadow-sm" : "border-gray-200"}`}
    >
      <button
        ...
        <section className="py-20 lg:py-28 bg-gray-50">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-14 space-y-4">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Whether it&apos;s a native mobile app, a high-traffic web
                platform, or both — we engineer it end to end.
              </p>
            </div>
        ...
        <div className="relative max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <div className="space-y-6 mb-10">
            ...
            <p className="text-xl text-gray-400 max-w-xl mx-auto leading-relaxed">
              Let&apos;s talk about your specific goals. 30-minute strategy
              call, no obligation, clear next steps.
            </p>
          </div>
